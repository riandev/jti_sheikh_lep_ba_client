...
const LeadGenerate = () => {
  ...
  const generateInitial = () => {
    fetch("http://192.168.10.11:5057/initialLead?initDate=" + initialDate)
      .then((res) => res.json())
      .then((data) => {
        setInitialLeads(
          data
  ...
  const updateInitialLeads = () => {
    fetch("http://192.168.10.11:5057/updateInitialLead", {
      method: "PATCH",
  ...
  const regenerateLeads = () => {
    fetch("http://192.168.10.11:5057/regenerate?regenDate=" + regenDate)
      .then((res) => res.json())
      .then((data) => {
        console.log(data);
        setRegenerate(
  ...
  const regenerateUpdate = () => {
    fetch("http://192.168.10.11:5057/regenerateUpdate", {
      method: "PATCH",
      headers: { "Content-Type": "application/json" },
